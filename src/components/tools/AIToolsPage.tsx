...
const tools: AITool[] = [
  ...
  },
  {
    ...
    description: "Chọn vùng trên ảnh và thay thế bằng nội dung mới do AI vẽ lại",
    category: "Chỉnh sửa",
  ...
  },
  {
    ...
    category: "Tạo ảnh",
    thumbnail: "/images/tools/sketch-to-image.jpg",
    available: false,
  },
  {
    id: "product-mockup",
    name: "Mockup sản phẩm",
    description: "Đặt sản phẩm vào bối cảnh chuyên nghiệp để chụp ảnh thương mại",
    category: "Tạo ảnh",
    thumbnail: "/images/tools/product-mockup.jpg",
    available: false,
  },
  {
    id: "ai-avatar",
    name: "Tạo Avatar AI",
    description: "Tạo ảnh đại diện phong cách từ ảnh chân dung của bạn",
    category: "Sáng tạo",
    thumbnail: "/images/tools/ai-avatar.jpg",
    available: false,
  },
  {
    id: "remove-object",
    name: "Xóa vật thể",
    description: "Xóa người, đồ vật hoặc chi tiết thừa ra khỏi ảnh một cách tự nhiên",
    category: "Chỉnh sửa",
  ...
  },
  {
    ...
    description: "Phân tích ảnh và tạo prompt mô tả chi tiết để tái tạo lại bằng AI",
    category: "Sáng tạo",
  ...
  {
    id: "smart-resize",
    name: "Resize thông minh",
    description: "Thay đổi tỉ lệ ảnh mà không bị cắt xén, AI tự bù nội dung thiếu",
    category: "Chỉnh sửa",
    thumbnail: "/images/tools/smart-resize.jpg",
    available: false,
  },
  {
    id: "ai-sticker",
    name: "Tạo Sticker AI",
    description: "Tạo sticker dễ thương, độc đáo từ mô tả hoặc ảnh có sẵn",
    category: "Sáng tạo",
    thumbnail: "/images/tools/ai-sticker.jpg",
    available: false,
  },
]
...
const gradientMap: Record<string, string> = {
  ...
  "smart-resize": "from-blue-600 via-indigo-500 to-violet-400",
