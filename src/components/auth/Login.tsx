                ...
                <Card className="w-full max-w-sm border-0 shadow-none">
                    ...
                    <CardContent className="px-0">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <a href={GOOGLE_REDIRECT} className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 w-full">
