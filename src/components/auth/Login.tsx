import { Sparkles, Wand2, Cpu, ArrowLeft } from "lucide-react"
...
export function Login() {
  return (
    <div className="grid min-h-svh lg:grid-cols-2 bg-background text-foreground relative">
      <div className="flex flex-col gap-4 p-6 md:p-10 relative">
        ...
        <div className="flex justify-center gap-2 md:justify-start mt-8 md:mt-0">
