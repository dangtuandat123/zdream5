    ...
    <>
      ...
      <Sonner
        ...
        toastOptions={{
          ...
          classNames: {
            toast:
              "w-full flex items-center gap-3 rounded-xl border border-white/10 bg-zinc-900/80 backdrop-blur-xl pl-4 pr-7 py-3 shadow-2xl shadow-black/40 text-sm text-zinc-100",
