        ...
        <div className="w-full max-w-5xl mx-auto space-y-6">
            <div className="space-y-6 pb-20">
                ...
                {uploadedImage && !isGenerating && generatedImages.length === 0 && (
                    <div className="flex flex-col justify-center min-h-[60vh] lg:min-h-[calc(100vh-80px)] gap-6 w-full max-w-2xl mx-auto animate-in fade-in zoom-in-95 duration-300">
            ...
            <ToolWorkspaceLayout
                canvas={
                    !uploadedImage && generatedImages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center min-h-[60vh] lg:min-h-[calc(100vh-80px)] w-full max-w-2xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500">
