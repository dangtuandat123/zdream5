...
{/* === XÁC NHẬN XOÁ === */}
                ...
                <div ref={promptContainerRef} className="sticky bottom-0 z-50 mx-auto w-full max-w-2xl px-3 sm:px-4 pb-[max(1rem,env(safe-area-inset-bottom))] sm:pb-6 pt-10 sm:pt-6 pointer-events-none bg-gradient-to-b from-transparent to-background to-[40%] sm:bg-none">
                    ...
                    <div className="relative w-full pointer-events-auto">
                        ...
                        <div
                            className={`relative flex flex-col w-full transition-all duration-300 border rounded-[30px] backdrop-blur-xl overflow-hidden ${isDragging ? 'border-primary/80 border-2 bg-primary/5 scale-[1.02] shadow-[0_0_40px_-10px_rgba(255,255,255,0.2)]' : 'border-border/30 bg-[#37393b]/85 shadow-lg'}`}
                        ...
                        >
                            ...
                            {referenceImages.length > 0 && (
                                <div className="mx-5 pb-1 pt-5 flex gap-2 overflow-x-auto [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-muted-foreground/30">
