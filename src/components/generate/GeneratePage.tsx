    ...
    return (
        ...
        <TooltipProvider>
            <div className="relative flex flex-1 flex-col min-w-0">
                ...
                <div ref={promptContainerRef} className="sticky bottom-0 z-50 mx-auto w-full max-w-3xl px-3 sm:px-4 pb-[max(1rem,env(safe-area-inset-bottom))] sm:pb-6 pt-10 pointer-events-none" style={{ background: 'linear-gradient(to bottom, transparent 0%, hsl(var(--background)) 40%)' }}>
