...
class AdminSeeder extends Seeder
{
    ...
    private function seedTemplates(): void
    {
        ...
        $templates = [
            ['name' => 'Chân dung Cyberpunk', 'category' => 'Chân dung', 'description' => 'Biến đổi ảnh thành phong cách Cyberpunk với ánh neon rực rỡ', 'system_prompt' => 'cyberpunk portrait, neon lights, cinematic', 'thumbnail' => 'https://images.unsplash.com/photo-1542442828-287217bfb21f?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Phong cảnh Ghibli', 'category' => 'Anime', 'description' => 'Chuyển đổi ảnh phong cảnh thành phong cách Studio Ghibli', 'system_prompt' => 'studio ghibli style landscape, watercolor', 'thumbnail' => 'https://images.unsplash.com/photo-1498453488252-0974dcabe0cb?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Render sản phẩm 3D', 'category' => '3D', 'description' => 'Tạo ảnh render 3D siêu thực cho sản phẩm', 'system_prompt' => '3D product render, studio lighting, white background', 'thumbnail' => 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Logo Minimalist', 'category' => 'Logo', 'description' => 'Thiết kế lại logo theo phong cách tối giản', 'system_prompt' => 'minimalist logo, clean lines, vector', 'thumbnail' => 'https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Sơn dầu cổ điển', 'category' => 'Phong cảnh', 'description' => 'Mang vẻ đẹp cổ điển Baroque cho ảnh', 'system_prompt' => 'baroque oil painting, classical, dramatic', 'thumbnail' => 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Anime Waifu', 'category' => 'Anime', 'description' => 'Tạo nhân vật anime từ ảnh chân dung', 'system_prompt' => 'anime character, waifu, cute style', 'thumbnail' => 'https://images.unsplash.com/photo-1578632767115-351597cf2477?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Ảnh thời trang', 'category' => 'Chân dung', 'description' => 'Ảnh chân dung thời trang cao cấp', 'system_prompt' => 'high fashion portrait, editorial, vogue style', 'thumbnail' => 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Concept Art', 'category' => 'Phong cảnh', 'description' => 'Concept art game/phim', 'system_prompt' => 'concept art, epic landscape, cinematic lighting', 'thumbnail' => 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Mockup sản phẩm', 'category' => 'Sản phẩm', 'description' => 'Ảnh mockup sản phẩm chuyên nghiệp', 'system_prompt' => 'product mockup, professional photography, clean', 'thumbnail' => 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Chibi Avatar', 'category' => 'Anime', 'description' => 'Avatar chibi dễ thương', 'system_prompt' => 'chibi avatar, cute, kawaii, colorful', 'thumbnail' => 'https://images.unsplash.com/photo-1608889825103-eb5ed706fc64?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Pixel Art', 'category' => '3D', 'description' => 'Pixel art retro game', 'system_prompt' => 'pixel art, 8-bit retro game style', 'thumbnail' => 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=400&auto=format&fit=crop'],
            ['name' => 'Watercolor Portrait', 'category' => 'Chân dung', 'description' => 'Chân dung phong cách màu nước', 'system_prompt' => 'watercolor portrait, soft colors, artistic', 'thumbnail' => 'https://images.unsplash.com/photo-1579783901586-d88db74b4fe4?q=80&w=400&auto=format&fit=crop'],
        ];
        ...
        foreach ($templates as $i => $t) {
            Template::updateOrCreate(
                ...
                array_merge($t, [
                    ...
                    'effect_groups' => [
                        ['name' => 'Bối cảnh', 'options' => $defaultContext],
                        ['name' => 'Chất liệu', 'options' => $defaultMaterial],
                    ],
                    'sort_order' => $i,
                    'is_active' => true,
                ]),
